  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between gap-2">
        <CardTitle>Valentine Suggestions</CardTitle>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {restaurants.map((restaurant) => (
            <div key={restaurant.id} className="rounded-lg border p-3">
              ...
              <p className="mt-1 text-xs text-muted-foreground">{restaurant.phone}</p>
              <p className="mt-1 text-xs text-muted-foreground">{restaurant.reservation_hint}</p>
